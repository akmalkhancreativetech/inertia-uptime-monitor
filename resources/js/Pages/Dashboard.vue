...
const page = usePage()
const endpointFrequencies = computed(() => page.props.endpointFrequencies)
const endpointForm = useForm({
    location: null,
    frequency: endpointFrequencies.value.data[0].frequency
})
    ...
    <AuthenticatedLayout>
        ...
        <div class="py-12">
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                <h2 class="text-lg font-semibold text-gray-800 leading-tight">New endpoint</h2>
                <form v-on:submit.prevent="storeEndpoint"
                    ...
                    <div class="grow">
                        ...
                        <TextInput v-model="endpointForm.location" id="location" type="text"
                    ...
                    <div>
                        ...
                        <select v-model="endpointForm.frequency" name="frequency" id="frequency"
                                class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm h-9 leading-none text-sm">
                            <option :value="frequency.frequency" v-for="frequency in endpointFrequencies.data"
                ...
                <div class="mt-8">
                    <h2 class="text-lg font-semibold text-gray-800 leading-tight">Currently monitoring ({{
